...
namespace HierarchyHelper
{
	...
	public static class HierarchyHelperManager
	{
        ...
        public static SortedList<string, CateInfo> Categroies { get; private set; }
		...
		static HierarchyHelperManager()
		{
            ...
            Categroies = new SortedList<string, CateInfo>();
			...
			foreach( MethodInfo m in methods )
			{
				...
				if( !_cache.Contains( key ) )
				{
					...
					foreach( object obj in objs )
					{
                        ...
                        {
                            Categroies[attr.Category] = new CateInfo();
                            Categroies[attr.Category].attrnum = 0;
                            Categroies[attr.Category].priority = attr.Priority;

                        }
                        Categroies[attr.Category].attrnum++;
					}
				}
			}
